...
void transpose_tma(TransposeParams<Element> params)
{
    ...
    auto vecLayoutS = make_layout(make_shape(Int<1>{}, Int<8>{}));
    ...
    auto tmaD = make_tma_copy(SM90_TMA_STORE{}, tensor_D, smemLayoutD, tileShapeD, Int<1>{});

    // auto tileShapeM = make_shape(Int<4>{}, Int<8>{}, Int<32>{});
    auto tileShapeM = make_shape(Int<8>{}, Int<8>{}, Int<32>{}); // (bM,bN)
    ...
    auto threadLayoutM = make_layout(make_shape(Int<1>{}, Int<8>{}, Int<32>{}),
                                     make_stride(Int<1>{}, Int<1>{}, Int<8>{})); // Right
...
#ifdef LP_DEBUG
    if (thread0()) {
        print("tiled_copy_S: "); print(tiled_copy_S); print("\n");
        ...
        print("make_layout(tileShapeM): "); print(make_layout(tileShapeM)); print("\n");
        print("smemLayoutD: "); print(smemLayoutD); print("\n");
        print("smemLayoutM: "); print(smemLayoutM); print("\n");
        print("threadLayoutM: "); print(threadLayoutM); print("\n");
        print("tmaD: ");print(tmaD);print("\n");
